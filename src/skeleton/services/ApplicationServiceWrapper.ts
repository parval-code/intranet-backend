...
export default class ApplicationServiceWrapper<T> {
  ...
  get() {
    return async (req: Request | any, res: Response | any, next: NextFunction) => {
      res['result'] = await this.service.get(req.params.id, req.query, this.app);
      next();
    };
  }
  ...
  create() {
    ...
    return async (req: Request | any, res: Response | any, next: NextFunction) => {
      res['result'] = await this.service.create(req.body, req.query, this.app);
      next();
    };
  }
  ...
  update() {
    return async (req: Request | any, res: Response | any, next: NextFunction) => {
      res['result'] = await this.service.update(
        req.params.id,
        req.body,
        req.query,
        this.app,
  ...
  delete() {
    return async (req: Request | any, res: Response | any, next: NextFunction) => {
      res['result'] = await this.service.delete(req.params.id, req.query, this.app);
      next();
    };
  }
}
