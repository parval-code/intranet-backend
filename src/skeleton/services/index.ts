...
export function createService<T extends BaseEntity>(
  ...
  const repository: any = getRepository(entity);
...
export function registerService<T>(
  ...
  return {
    register: (app: IAppProvider) => {
      ...
      const wrapper: any = new ApplicationServiceWrapper<T>(app, service);
      const middlewareBefore: any = options.middlewares.before;
      const middlewareAfter: any = options.middlewares.after;
